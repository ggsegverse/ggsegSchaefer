...
#> ────────────────────────────────────────────────────────────────────────────────
#>    hemi                          region                              label
#> 1  left 17Networks_LH_VisCent_Striate_1 lh_17Networks_LH_VisCent_Striate_1
#> 2  left 17Networks_LH_VisCent_Striate_2 lh_17Networks_LH_VisCent_Striate_2
#> 3  left 17Networks_LH_VisCent_Striate_3 lh_17Networks_LH_VisCent_Striate_3
#> 4  left 17Networks_LH_VisCent_Striate_4 lh_17Networks_LH_VisCent_Striate_4
...
#> ... with 990 more rows
if (FALSE) plot(schaefer17_1000()) # \dontrun{}
```
